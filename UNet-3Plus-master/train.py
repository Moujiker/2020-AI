...
arch_names = list(UNet_3Plus.__dict__.keys())
...
def parse_args():
    ...
    parser.add_argument('--arch', '-a', metavar='ARCH', default='UNet_3Plus',
                        choices=arch_names,
...
def main():
    ...
    # Data loading code
    img_paths = glob(r'C:\work\gitlab\2020\baseline\train\images\*')
    mask_paths = glob(r'C:\work\gitlab\2020\baseline\train\labels\*')
